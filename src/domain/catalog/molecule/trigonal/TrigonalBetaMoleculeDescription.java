...
public class TrigonalBetaMoleculeDescription extends TrigonalMoleculeDescription {

	public TrigonalBetaMoleculeDescription() {
		super();
	...
	public void assignDirectory() {
		...
		this.setImageDirectory("images/betaMolTri.png");
